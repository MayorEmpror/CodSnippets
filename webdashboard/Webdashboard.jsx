...
import Settings from "./MainPanel/SideOptions/Settings/Settings";
import Profile from "./MainPanel/SideOptions/Profile/Profile";
import Chats from "./MainPanel/SideOptions/Chats";
import AllSnippets from "./MainPanel/SideOptions/AllSnippets/AllSnippets";
import Favorites from "./MainPanel/SideOptions/Favourites/Favorites";
import Accounts from "./MainPanel/SideOptions/Account/Account";
import LandingPage from "./MainPanel/SideOptions/LandingPage/LandingPage";
...
export default function Dashboard() {
  ...
  const RoutingData = [
    ...
    { path: "/About", element: <LandingPage mobile={mobile} /> },
